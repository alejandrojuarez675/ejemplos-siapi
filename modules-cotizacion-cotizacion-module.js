(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-cotizacion-cotizacion-module"],{
...
/*!*****************************************************************!*\
  !*** ./src/app/modules/cotizacion/cotizacion-routing.module.ts ***!
  \*****************************************************************/
/*! exports provided: routes, CotizacionRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _pages_cotizacion_page_cotizacion_page_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/cotizacion-page/cotizacion-page.component */ "./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.ts");
/* harmony import */ var _pages_formulario_completo_formulario_completo_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/formulario-completo/formulario-completo.component */ "./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.ts");
/* harmony import */ var _pages_formulario_interactivo_formulario_interactivo_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/formulario-interactivo/formulario-interactivo.component */ "./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.ts");
...
var routes = [
    { path: '', component: _pages_cotizacion_page_cotizacion_page_component__WEBPACK_IMPORTED_MODULE_3__["CotizacionPageComponent"] },
    { path: 'formulario-completo', component: _pages_formulario_completo_formulario_completo_component__WEBPACK_IMPORTED_MODULE_4__["FormularioCompletoComponent"] },
    { path: 'formulario-interactivo', component: _pages_formulario_interactivo_formulario_interactivo_component__WEBPACK_IMPORTED_MODULE_5__["FormularioInteractivoComponent"] },
    { path: '**', redirectTo: '' },
];
var CotizacionRoutingModule = /** @class */ (function () {
    function CotizacionRoutingModule() {
    }
...
/* harmony import */ var _cotizacion_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cotizacion-routing.module */ "./src/app/modules/cotizacion/cotizacion-routing.module.ts");
/* harmony import */ var _pages_cotizacion_page_cotizacion_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/cotizacion-page/cotizacion-page.component */ "./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.ts");
/* harmony import */ var _pages_formulario_completo_formulario_completo_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./pages/formulario-completo/formulario-completo.component */ "./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.ts");
/* harmony import */ var _pages_formulario_interactivo_formulario_interactivo_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/formulario-interactivo/formulario-interactivo.component */ "./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.ts");
...
var CotizacionModule = /** @class */ (function () {
    function CotizacionModule() {
    }
    CotizacionModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                _pages_formulario_completo_formulario_completo_component__WEBPACK_IMPORTED_MODULE_5__["FormularioCompletoComponent"],
                _pages_formulario_interactivo_formulario_interactivo_component__WEBPACK_IMPORTED_MODULE_6__["FormularioInteractivoComponent"],
                _pages_cotizacion_page_cotizacion_page_component__WEBPACK_IMPORTED_MODULE_4__["CotizacionPageComponent"]
            ],
            imports: [
                _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
                _cotizacion_routing_module__WEBPACK_IMPORTED_MODULE_3__["CotizacionRoutingModule"],
...
/***/ "./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.css":
/*!****************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.css ***!
  \****************************************************************************************/
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvY290aXphY2lvbi9wYWdlcy9jb3RpemFjaW9uLXBhZ2UvY290aXphY2lvbi1wYWdlLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.html":
/*!*****************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.html ***!
  \*****************************************************************************************/
/*! no static exports found */
...
module.exports = "<h2>Cotización</h2>\n\n"

/***/ }),

/***/ "./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.ts":
/*!***************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.ts ***!
  \***************************************************************************************/
/*! exports provided: CotizacionPageComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CotizacionPageComponent", function() { return CotizacionPageComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var CotizacionPageComponent = /** @class */ (function () {
    function CotizacionPageComponent() {
    }
    CotizacionPageComponent.prototype.ngOnInit = function () {
    };
    CotizacionPageComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-cotizacion-page',
            template: __webpack_require__(/*! ./cotizacion-page.component.html */ "./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.html"),
            styles: [__webpack_require__(/*! ./cotizacion-page.component.css */ "./src/app/modules/cotizacion/pages/cotizacion-page/cotizacion-page.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], CotizacionPageComponent);
    return CotizacionPageComponent;
}());
...
/***/ "./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.css":
/*!************************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.css ***!
  \************************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvY290aXphY2lvbi9wYWdlcy9mb3JtdWxhcmlvLWNvbXBsZXRvL2Zvcm11bGFyaW8tY29tcGxldG8uY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.html":
/*!*************************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.html ***!
  \*************************************************************************************************/
/*! no static exports found */
...
module.exports = "<h2>Ejemplo de Formulario Completo </h2>\n<p>Las preguntas serán envíadas automaticamente al terminar el formulario.</p>\n<hr>\n\n<ng-container *ngIf=\"!fin\">\n\n    <h3 *ngIf=\"objetos.length > 0\">Objetos:</h3>\n    <form>\n        <div *ngFor=\"let objeto of objetos\">\n            <input type=\"radio\" [id]=\"objeto.codigo\" \n                [name]=\"objeto\" [(ngModel)]=\"objetoSelected\"\n                [value]=\"objeto.codigo\" \n                (ngModelChange)=\"elijoObjeto($event)\">\n            <label [for]=\"objeto.codigo\">{{objeto.descripcion}}</label>\n        </div>\n    </form>\n\n    <h3 *ngIf=\"indicios.length > 0\">Indicios:</h3>\n    <form>\n        <div *ngFor=\"let indicio of indicios\">\n            <input type=\"radio\" [id]=\"indicio.codigo\" \n                [name]=\"indicio\" [(ngModel)]=\"indicioSelected\"\n                [value]=\"indicio.codigo\" \n                (ngModelChange)=\"elijoIndicio($event)\">\n            <label [for]=\"indicio.codigo\">{{indicio.descripcion}}</label>\n        </div>\n    </form>\n\n    <h3 *ngIf=\"alertas.length > 0\">Alertas:</h3>\n    <ul *ngFor=\"let alerta of alertas\">\n        <li>{{alerta.texto}}</li>\n    </ul>\n    \n    <hr *ngIf=\"preguntas.length > 0\">\n    <h3 *ngIf=\"preguntas.length > 0\">Preguntas:</h3>\n    <ng-container *ngFor=\"let pregunta of preguntas\" >\n\n        <p [title]=\"pregunta.significado\">{{pregunta.texto}}</p>\n        <p style=\"font-size:11px\">{{pregunta.significado}}</p>\n\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'number'\">\n            <input type=\"number\" [(ngModel)]=\"pregunta.valor\" \n                (focusout)=\"onFinEscrituraEnInput($event, pregunta.codigo)\">\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'texto'\">\n            <input type=\"texto\" [(ngModel)]=\"pregunta.valor\" \n                (focusout)=\"onFinEscrituraEnInput($event, pregunta.codigo)\">\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'date'\">\n            <input type=\"date\" [(ngModel)]=\"pregunta.valor\" \n                (focusout)=\"onFinEscrituraEnInput($event, pregunta.codigo)\">\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'simple_option'\">\n            <form>\n                <div *ngFor=\"let opcion of pregunta.opcion\">\n                    <input type=\"radio\" [id]=\"opcion.codigo\" \n                        [name]=\"pregunta.codigo\" [title]=\"opcion.significado\"\n                        [value]=\"opcion.codigo\" [(ngModel)]=\"pregunta.valor\"\n                        (ngModelChange)=\"elijoOpcion($event, pregunta.codigo)\">\n                    <label [for]=\"opcion.codigo\">{{opcion.texto}}</label>\n                </div>\n            </form>\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'boolean'\">\n            <form>\n                <div>\n                    <input type=\"radio\" id=\"true\"\n                        [name]=\"pregunta.codigo\" \n                        [value]=\"true\" [(ngModel)]=\"pregunta.valor\" \n                        (ngModelChange)=\"elijoOpcion($event, pregunta.codigo)\">\n                    <label for=\"true\">Si</label>\n                </div>\n                <div>\n                    <input type=\"radio\" id=\"false\"\n                        [name]=\"pregunta.codigo\"\n                        [value]=\"false\" [(ngModel)]=\"pregunta.valor\"\n                        (ngModelChange)=\"elijoOpcion($event, pregunta.codigo)\">\n                    <label for=\"false\">No</label>\n                </div>\n            </form>\n        </ng-container>\n    </ng-container>\n</ng-container>\n\n\n<ng-container *ngIf=\"fin && planes.length == 0\">\n    <h2>Envíando el siguiente fomulario a cotizar!</h2>\n</ng-container>\n\n\n<ng-container *ngIf=\"planes.length > 0\" style=\"align-content: center;\">\n    <h2>Los planes disponibles son:</h2>\n\n    <div *ngFor=\"let plan of planes\" style=\"float: left; width: 300px;\">\n        <h3>{{plan.descripcion}}</h3>\n        <p style=\"font-size:11px\">{{plan.informacionAdicional}}</p>\n        <p style=\"font-size:11px\">\n            La poliza tiene una duración de {{plan.duracion.cantidad}} año.\n        </p>\n\n        <p *ngIf=\"plan.cobertura.length > 0\">Cobertura:</p>\n        <ul *ngFor=\"let cobertura of plan.cobertura\">\n            {{cobertura.descripcion}} ${{cobertura.sumaAsegurada || '-'}}\n        </ul>\n\n        <p *ngIf=\"plan.caracteristica.length > 0\">Características:</p>\n        <ul *ngFor=\"let caracteristica of plan.caracteristica\">\n            {{caracteristica.descripcion}} ({{caracteristica.informacionAdicional}})\n        </ul>\n\n        <p *ngIf=\"plan.beneficio.length > 0\">Beneficios Extras:</p>\n        <ul *ngFor=\"let beneficio of plan.beneficio\">\n            {{beneficio.descripcion}}\n        </ul>\n\n        <b>Precio del plan: {{plan.formaPago[0].precioCuota | currency}} por mes</b>\n    </div>\n</ng-container>"

/***/ }),

/***/ "./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.ts":
/*!***********************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.ts ***!
  \***********************************************************************************************/
/*! exports provided: FormularioCompletoComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormularioCompletoComponent", function() { return FormularioCompletoComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_core_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/services/cotizacion.service */ "./src/app/core/services/cotizacion.service.ts");



var FormularioCompletoComponent = /** @class */ (function () {
    function FormularioCompletoComponent(cotizacionService) {
    ...
    FormularioCompletoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.fin = false;
        this.cotizacionService.getObjetos().subscribe(function (objetos) { return _this.objetos = objetos; });
    };
    FormularioCompletoComponent.prototype.elijoObjeto = function (codObjeto) {
        var _this = this;
        this.objetos = [];
        this.objetoSelected = codObjeto;
        this.cotizacionService.getIndiciosByObjeto(codObjeto).subscribe(function (indicios) { return _this.indicios = indicios; });
    };
    FormularioCompletoComponent.prototype.elijoIndicio = function (codIndicio) {
        this.indicios = [];
        this.indicioSelected = codIndicio;
        this.inicializarFormulario();
    };
    FormularioCompletoComponent.prototype.inicializarFormulario = function () {
        var _this = this;
        this.cotizacionService.getFormulario(this.objetoSelected, this.indicioSelected).subscribe(function (formulario) {
            _this.formulario = formulario;
            _this.alertas = formulario.inicio.alerta
                .map(function (cod) { return _this.getAlertaByCodigo(cod, formulario.alerta); })
                .filter(function (al) { return al; });
            _this.preguntas = formulario.inicio.pregunta
                .map(function (cod) { return _this.getPreguntaByCodigo(cod, formulario.pregunta); })
                .filter(function (preg) { return preg; })
                .map(function (preg) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, preg, { valor: undefined })); });
        }, function (_error) { return alert('Problemas de conexión'); });
    };
    FormularioCompletoComponent.prototype.getPreguntaByCodigo = function (codigo, preguntas) {
        preguntas = preguntas || this.formulario.pregunta;
        return preguntas.filter(function (preg) { return preg.codigo === codigo; }).shift();
    };
    FormularioCompletoComponent.prototype.getAlertaByCodigo = function (codigo, alertas) {
        alertas = alertas || this.formulario.alerta;
        return alertas.filter(function (al) { return al.codigo === codigo; }).shift();
    };
    FormularioCompletoComponent.prototype.elijoOpcion = function (codOpcion, codPregunta) {
        this.fin = false;
        this.respuestas = this.respuestas
            .filter(function (resp) { return resp.codigoPregunta !== codPregunta; });
        var respuestaNueva = {
            codigoPregunta: codPregunta, valor: [codOpcion]
        };
        this.respuestas = this.respuestas.concat([respuestaNueva]);
        this.addNuevasAlertasALista();
        if (this.preguntas.length === this.respuestas.length) {
            this.addNuevasPreguntasALista();
        }
    };
    FormularioCompletoComponent.prototype.onFinEscrituraEnInput = function (_event, codPregunta) {
        this.fin = false;
        this.respuestas = this.respuestas
            .filter(function (resp) { return resp.codigoPregunta !== codPregunta; });
        var respuesta = this.preguntas
            .filter(function (preg) { return preg.codigo === codPregunta; })[0].valor;
        var respuestaNueva = {
            codigoPregunta: codPregunta, valor: [respuesta]
        };
        this.respuestas = this.respuestas.concat([respuestaNueva]);
        this.addNuevasAlertasALista();
        if (this.preguntas.length === this.respuestas.length) {
    ...
    FormularioCompletoComponent.prototype.addNuevasAlertasALista = function () {
        var _this = this;
        var alertasIniciales = this.formulario.inicio.alerta
            .map(function (codAlerta) { return _this.getAlertaByCodigo(codAlerta); });
        var nuevasAlertas = this.respuestas
            .map(function (resp) { return _this.getOpcionByRespuesta(resp); })
            .filter(function (opc) { return opc; })
            .map(function (opc) { return opc.alerta; })
            .reduce(function (a, b) { return a.concat(b); }, [])
            .filter(function (codAleta) { return !_this.formulario.inicio.alerta.includes(codAleta); })
            .map(function (codAlerta) { return _this.getAlertaByCodigo(codAlerta); });
        this.alertas = alertasIniciales.concat(nuevasAlertas);
    };
    FormularioCompletoComponent.prototype.addNuevasPreguntasALista = function () {
        var _this = this;
        var proximasPreguntas = this.respuestas
            .map(function (resp) { return _this.getOpcionByRespuesta(resp); })
            .filter(function (opc) { return opc; })
            .map(function (opc) { return opc.preguntaSiguiente; })
            .reduce(function (a, b) { return a.concat(b); }, [])
            .filter(function (codPreg) { return !_this.preguntas.map(function (p) { return p.codigo; }).includes(codPreg); })
            .map(function (codPreg) { return _this.getPreguntaByCodigo(codPreg); })
            .map(function (preg) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, preg, { valor: undefined })); });
        if (proximasPreguntas.length === 0) {
            this.fin = true;
            this.cotizar();
        }
        else {
            this.preguntas = this.preguntas.concat(proximasPreguntas);
        }
    };
    FormularioCompletoComponent.prototype.getOpcionByRespuesta = function (resp) {
        var pregunta = this.getPreguntaByCodigo(resp.codigoPregunta);
        var opcion;
        if (pregunta.tipoRespuesta === 'simple_option') {
            opcion = pregunta.opcion.filter(function (opc) { return resp.valor.includes(opc.codigo); })[0];
        }
        return opcion;
    };
    FormularioCompletoComponent.prototype.cotizar = function () {
        var _this = this;
        this.cotizacionService.submitRespuestas(this.objetoSelected, this.indicioSelected, {
            respuesta: this.respuestas
        }).subscribe(function (response) {
            var consultaId = response.consultaId;
            _this.cotizacionService.getCotizacion(consultaId).subscribe(function (planes) { return _this.planes = planes; });
        });
    };
    FormularioCompletoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-formulario-completo',
            template: __webpack_require__(/*! ./formulario-completo.component.html */ "./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.html"),
            styles: [__webpack_require__(/*! ./formulario-completo.component.css */ "./src/app/modules/cotizacion/pages/formulario-completo/formulario-completo.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_core_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_2__["CotizacionService"]])
    ], FormularioCompletoComponent);
    return FormularioCompletoComponent;
}());
...
/***/ "./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.css":
/*!******************************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.css ***!
  \******************************************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL21vZHVsZXMvY290aXphY2lvbi9wYWdlcy9mb3JtdWxhcmlvLWludGVyYWN0aXZvL2Zvcm11bGFyaW8taW50ZXJhY3Rpdm8uY29tcG9uZW50LmNzcyJ9 */"

/***/ }),

/***/ "./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.html":
/*!*******************************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.html ***!
  \*******************************************************************************************************/
/*! no static exports found */
...
module.exports = "<h2>Ejemplo de Formulario Interactivo </h2>\n<p>Las preguntas serán mostradas de a una a la vez.</p>\n<hr>\n\n<ng-container *ngIf=\"!fin\">\n\n    <h3 *ngIf=\"objetos.length > 0\">Objetos:</h3>\n    <form>\n        <div *ngFor=\"let objeto of objetos\">\n            <input type=\"radio\" [id]=\"objeto.codigo\" \n                [name]=\"objeto\" [(ngModel)]=\"objetoSelected\"\n                [value]=\"objeto.codigo\" \n                (ngModelChange)=\"elijoObjeto($event)\">\n            <label [for]=\"objeto.codigo\">{{objeto.descripcion}}</label>\n        </div>\n    </form>\n\n    <h3 *ngIf=\"indicios.length > 0\">Indicios:</h3>\n    <form>\n        <div *ngFor=\"let indicio of indicios\">\n            <input type=\"radio\" [id]=\"indicio.codigo\" \n                [name]=\"indicio\" [(ngModel)]=\"indicioSelected\"\n                [value]=\"indicio.codigo\" \n                (ngModelChange)=\"elijoIndicio($event)\">\n            <label [for]=\"indicio.codigo\">{{indicio.descripcion}}</label>\n        </div>\n    </form>\n\n    <h3 *ngIf=\"alertas.length > 0\">Alertas:</h3>\n    <ul *ngFor=\"let alerta of alertas\">\n        <li>{{alerta.texto}}</li>\n    </ul>\n    \n    <hr *ngIf=\"preguntas.length > 0\">\n    <h3 *ngIf=\"preguntas.length > 0\">Pregunta:</h3>\n    <ng-container *ngFor=\"let pregunta of preguntas\" >\n    \n        <p [title]=\"pregunta.significado\">{{pregunta.texto}}</p>\n        <p style=\"font-size:11px\">{{pregunta.significado}}</p>\n\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'number'\">\n            <input type=\"number\" [(ngModel)]=\"pregunta.valor\" \n                (focusout)=\"onFinEscrituraEnInput($event, pregunta.codigo)\">\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'texto'\">\n            <input type=\"texto\" [(ngModel)]=\"pregunta.valor\" \n                (focusout)=\"onFinEscrituraEnInput($event, pregunta.codigo)\">\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'date'\">\n            <input type=\"date\" [(ngModel)]=\"pregunta.valor\" \n                (focusout)=\"onFinEscrituraEnInput($event, pregunta.codigo)\">\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'simple_option'\">\n            <form>\n                <div *ngFor=\"let opcion of pregunta.opcion\">\n                    <input type=\"radio\" [id]=\"opcion.codigo\" \n                        [name]=\"pregunta.codigo\" [title]=\"opcion.significado\"\n                        [value]=\"opcion.codigo\" [(ngModel)]=\"pregunta.valor\"\n                        (ngModelChange)=\"elijoOpcion($event, pregunta.codigo)\">\n                    <label [for]=\"opcion.codigo\">{{opcion.texto}}</label>\n                </div>\n            </form>\n        </ng-container>\n        <ng-container *ngIf=\"pregunta.tipoRespuesta == 'boolean'\">\n            <form>\n                <div>\n                    <input type=\"radio\" id=\"true\"\n                        [name]=\"pregunta.codigo\" \n                        [value]=\"true\" [(ngModel)]=\"pregunta.valor\" \n                        (ngModelChange)=\"elijoOpcion($event, pregunta.codigo)\">\n                    <label for=\"true\">Si</label>\n                </div>\n                <div>\n                    <input type=\"radio\" id=\"false\"\n                        [name]=\"pregunta.codigo\"\n                        [value]=\"false\" [(ngModel)]=\"pregunta.valor\"\n                        (ngModelChange)=\"elijoOpcion($event, pregunta.codigo)\">\n                    <label for=\"false\">No</label>\n                </div>\n            </form>\n        </ng-container>\n    </ng-container>\n</ng-container>\n\n\n<ng-container *ngIf=\"fin && planes.length == 0\">\n    <h2>Envíando el siguiente fomulario a cotizar!</h2>\n</ng-container>\n\n\n<ng-container *ngIf=\"planes.length > 0\" style=\"align-content: center;\">\n    <h2>Los planes disponibles son:</h2>\n\n    <div *ngFor=\"let plan of planes\" style=\"float: left; width: 300px;\">\n        <h3>{{plan.descripcion}}</h3>\n        <p style=\"font-size:11px\">{{plan.informacionAdicional}}</p>\n        <p style=\"font-size:11px\">\n            La poliza tiene una duración de {{plan.duracion.cantidad}} año.\n        </p>\n\n        <p *ngIf=\"plan.cobertura.length > 0\">Cobertura:</p>\n        <ul *ngFor=\"let cobertura of plan.cobertura\">\n            {{cobertura.descripcion}} ${{cobertura.sumaAsegurada || '-'}}\n        </ul>\n\n        <p *ngIf=\"plan.caracteristica.length > 0\">Características:</p>\n        <ul *ngFor=\"let caracteristica of plan.caracteristica\">\n            {{caracteristica.descripcion}} ({{caracteristica.informacionAdicional}})\n        </ul>\n\n        <p *ngIf=\"plan.beneficio.length > 0\">Beneficios Extras:</p>\n        <ul *ngFor=\"let beneficio of plan.beneficio\">\n            {{beneficio.descripcion}}\n        </ul>\n\n        <b>Precio del plan: {{plan.formaPago[0].precioCuota | currency}} por mes</b>\n    </div>\n</ng-container>"

/***/ }),

/***/ "./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.ts":
/*!*****************************************************************************************************!*\
  !*** ./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.ts ***!
  \*****************************************************************************************************/
/*! exports provided: FormularioInteractivoComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormularioInteractivoComponent", function() { return FormularioInteractivoComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_core_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/core/services/cotizacion.service */ "./src/app/core/services/cotizacion.service.ts");
...
var FormularioInteractivoComponent = /** @class */ (function () {
    function FormularioInteractivoComponent(cotizacionService) {
        this.cotizacionService = cotizacionService;
        this.objetos = [];
        this.indicios = [];
        this.preguntas = [];
    ...
    FormularioInteractivoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.fin = false;
        this.cotizacionService.getObjetos().subscribe(function (objetos) { return _this.objetos = objetos; });
    };
    FormularioInteractivoComponent.prototype.elijoObjeto = function (codObjeto) {
        var _this = this;
        this.objetos = [];
        this.objetoSelected = codObjeto;
        this.cotizacionService.getIndiciosByObjeto(codObjeto).subscribe(function (indicios) { return _this.indicios = indicios; });
    };
    FormularioInteractivoComponent.prototype.elijoIndicio = function (codIndicio) {
        this.indicios = [];
        this.indicioSelected = codIndicio;
        this.inicializarFormulario();
    };
    FormularioInteractivoComponent.prototype.inicializarFormulario = function () {
        var _this = this;
        this.cotizacionService.getProximaPregunta(this.objetoSelected, this.indicioSelected, undefined)
            .subscribe(function (response) {
            _this.consultaId = response.consultaId;
            _this.alertas = response.alerta;
            _this.preguntas = response.pregunta
                .map(function (preg) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, preg, { valor: undefined })); });
        }, function (_error) { return alert('Problemas de conexión'); });
    };
    FormularioInteractivoComponent.prototype.elijoOpcion = function (codOpcion, codPregunta) {
        this.respuestas = this.respuestas
            .filter(function (resp) { return resp.codigoPregunta !== codPregunta; });
        var respuestaNueva = {
            codigoPregunta: codPregunta, valor: [codOpcion]
        };
        this.buscarProximaPregunta(respuestaNueva);
    };
    FormularioInteractivoComponent.prototype.onFinEscrituraEnInput = function (_event, codPregunta) {
        this.respuestas = this.respuestas
            .filter(function (resp) { return resp.codigoPregunta !== codPregunta; });
        var respuesta = this.preguntas
            .filter(function (preg) { return preg.codigo === codPregunta; })[0].valor;
    ...
    FormularioInteractivoComponent.prototype.buscarProximaPregunta = function (respuestaNueva) {
        this.respuestas = this.respuestas.concat([respuestaNueva]);
        if (this.preguntas.length === this.respuestas.length) {
            this.addNuevasPreguntasALista();
        }
    };
    FormularioInteractivoComponent.prototype.addNuevasPreguntasALista = function () {
        var _this = this;
        var request = {
            consultaId: this.consultaId,
            respuesta: this.respuestas
        };
        this.cotizacionService.getProximaPregunta(this.objetoSelected, this.indicioSelected, request)
            .subscribe(function (response) {
            var nuevasAlertas = response.alerta
                .filter(function (ale) { return !_this.alertas.map(function (a) { return a.codigo; }).includes(ale.codigo); });
            _this.alertas = _this.alertas.concat(nuevasAlertas);
            if (response.pregunta.length === 0) {
                _this.fin = true;
                _this.cotizar();
            }
            else {
                var nuevasPreguntas = response.pregunta
                    .filter(function (preg) { return !_this.preguntas.map(function (p) { return p.codigo; }).includes(preg.codigo); })
                    .map(function (preg) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, preg, { valor: undefined })); });
                _this.preguntas = nuevasPreguntas;
                _this.respuestas = [];
            }
        }, function (_error) { return alert('Problemas de conexión'); });
    };
    FormularioInteractivoComponent.prototype.cotizar = function () {
        var _this = this;
        this.cotizacionService.submitRespuestas(this.objetoSelected, this.indicioSelected, {
            respuesta: this.respuestas
        }).subscribe(function (response) {
    ...
    FormularioInteractivoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-formulario-interactivo',
            template: __webpack_require__(/*! ./formulario-interactivo.component.html */ "./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.html"),
            styles: [__webpack_require__(/*! ./formulario-interactivo.component.css */ "./src/app/modules/cotizacion/pages/formulario-interactivo/formulario-interactivo.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_core_services_cotizacion_service__WEBPACK_IMPORTED_MODULE_2__["CotizacionService"]])
    ], FormularioInteractivoComponent);
    return FormularioInteractivoComponent;
}());
...
//# sourceMappingURL=modules-cotizacion-cotizacion-module.js.map